...
cross-checked against Cummings 7e, Pasha 6e, and K.J. Lee 12e in the connected Drive corpus.
Contemporary object-specific timing is updated against the 2026 ESPGHAN position paper and
current National Capital Poison Center button-battery guidance.
"""
from concept_check_board_repair_v177 import _find_module

SOURCE_REFS_V207 = [
 {"type":"textbook","citation":"Cummings Otolaryngology: Head and Neck Surgery, 7th ed., Pediatric Aerodigestive Foreign Bodies chapter; connected Drive corpus.","role":"foundation/operative: symptoms and localization, AP/lateral radiography, coin-versus-button-battery signs, endoscopic retrieval principles, mucosal injury and delayed complications"},
 {"type":"textbook","citation":"Pasha R, Golub JS. Otolaryngology-Head and Neck Surgery: Clinical Reference Guide, 6th ed. (2022); connected Drive copy.","role":"foundation/operative: cervical esophageal anatomy, rigid endoscopy, foreign-body and food-impaction management"},
 {"type":"textbook","citation":"K.J. Lee's Essential Otolaryngology: Head & Neck Surgery, 12th ed. (2019); connected Drive copy.","role":"foundation/operative: esophageal anatomy, aerodigestive foreign-body presentation, endoscopic rescue and perforation awareness"},
 ...
 {"type":"current_society_teaching","citation":"ASGE. The 2 AM Page: A Fellow's Approach to Foreign Body Ingestion and Food Impaction. 2026-08-19.","role":"current practical timing and retrieval teaching: emergent complete obstruction/button battery/sharp esophageal object, urgent remaining esophageal foreign bodies, object-specific retrieval strategy and careful food-bolus technique"},
]
...
Object-specific urgency — complete esophageal obstruction with inability to manage secretions is emergent regardless of object type. An esophageal button battery is an immediate-removal emergency because severe alkali injury can develop rapidly. Sharp objects in the esophagus and magnets within endoscopic reach require urgent/emergent specialist removal according to object and physiology. A blunt coin in an asymptomatic child may sometimes be observed briefly for spontaneous passage, but persistent esophageal coins should be removed within the accepted short window rather than left for days.

Button battery nuance — if a child at least 12 months old swallowed a possible lithium coin cell within the prior 12 hours and can swallow, current Poison Center guidance supports honey during transport; after radiographic confirmation of an esophageal battery, sucralfate may also be used before endoscopy. Neither treatment substitutes for removal and neither should delay transport, anesthesia or endoscopy. After removal, inspect the injury and think beyond the mucosa: delayed tracheoesophageal fistula, recurrent laryngeal nerve injury, perforation, mediastinitis and catastrophic vascular fistula can occur after the battery is gone. Injury location relative to the aorta or other major vessels determines surveillance intensity.
...
Perforation concern — severe neck/chest pain, crepitus, fever, tachycardia, subcutaneous emphysema, pneumomediastinum or a difficult traumatic extraction should trigger evaluation for esophageal injury. Keep the patient NPO, involve surgery/ENT/GI early, use cross-sectional imaging with a contrast strategy appropriate to the scenario, and treat contamination/source control rather than reflexively performing repeated instrumentation. The repository's separate esophageal-perforation rescue pathway remains the detailed postoperative bailout.

Food impaction is not the endpoint — after successful disimpaction, ask why the food stuck. In children and young adults, eosinophilic esophagitis is a major underlying diagnosis; structural narrowing and motility disease also matter. When medically safe, obtain esophageal biopsies during the index evaluation/endoscopy when EoE is suspected rather than treating disimpaction as the complete diagnosis.
...
A complete obstruction is emergent even if the object is otherwise benign. Sharp esophageal objects and magnets within endoscopic reach deserve urgent/emergent removal because the complication is not just persistent dysphagia—it is perforation, fistula, bleeding or injury to adjacent structures. A stable asymptomatic coin may have a short observation window, but persistent esophageal location requires timely removal rather than outpatient neglect.
...
Food bolus cases require a second diagnosis. If the patient has recurrent solid-food dysphagia, atopy, rings/furrows or an otherwise unexplained impaction, think eosinophilic esophagitis. When safe, obtain adequate biopsies and arrange longitudinal treatment rather than simply documenting 'foreign body removed.'
...
COHORT={
 ...
 "explanation":"Esophageal foreign bodies are triaged by airway status, ability to handle secretions, object type, location and time since ingestion. Button batteries, complete obstruction and sharp esophageal objects are emergent phenotypes; magnets add object-specific urgency. Safe endoscopy requires planned object control and post-removal injury assessment.",
 ...
 "board_pearl":"Urgency follows physiology and object risk: inability to handle secretions, button battery, sharp esophageal object or magnet beats a comfortable-looking x-ray; force against an embedded object is a perforation trap.",
