"""v26.0 — strict 20-topic Facial Plastics / Trauma deliberate-ladder progress gate."""
...
def main():
    ...
    if failures:
        ...
        print("\n".join(failures))
        raise SystemExit(1)
    print("PASS: 20 exact canonical Facial Plastics / Trauma topics retain complete reviewed ladders and quality contracts")
