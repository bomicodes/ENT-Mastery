"""Final clinical-stem normalization plus exact-live v20.26 successor alignment.

The validated v20.25 implementation is preserved byte-for-byte in the adjacent source
module. This thin successor wrapper appends v20.26 after that complete ordered pipeline,
so no predecessor cohort or clinical-frame behavior is reconstructed or weakened.
"""
import concept_check_final_clinical_gate_v179_source_v225 as _base
from concept_check_final_clinical_gate_v179_source_v225 import *  # re-export validated public API
