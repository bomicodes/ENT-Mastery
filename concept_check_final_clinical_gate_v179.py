...
The v20.32 Cleft / Craniofacial Otologic-Airway Care cohort is applied last so its exact-live Pediatric
alignment cannot be overwritten by predecessor normalization.
"""
...
def apply_final_clinical_gate_v179(checks, deep_modules, v6_item_id):
    ...
    results["post_alignment_reframed_v232"] = _base._reassert_clinical_contract(
        checks, alignment_v232.get("repaired", []), results.get("unresolved", []), "post_alignment_clinical_frame_v232"
    )
    return results
