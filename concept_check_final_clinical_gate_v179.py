"""Final clinical-stem normalization plus exact-live v20.33 successor alignment.

The validated v20.30 implementation remains the complete predecessor. v20.33 adds an exact-canonical
Facial Pain / Headache vs Rhinogenic Disease Concept Check after inherited normalization so the
learner pathway is not fragmented between Deep Curriculum and Daily Curriculum.
"""
