"""v27.0 — strict General ENT / Emergencies 10-topic deliberate-ladder hard gate."""
...
def main():
    ...
    if failures:
        print("GENERAL ENT 10-TOPIC HARD-GATE FAILURES")
        print("\n".join(failures))
        raise SystemExit(1)
    print("PASS: 10 exact canonical General ENT / Emergencies topics retain complete reviewed ladders and quality contracts")
