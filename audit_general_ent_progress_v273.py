"""v27.3 — strict General ENT / Emergencies 25-topic deliberate-ladder hard gate."""
...
def main():
    ...
    if failures:
        print("GENERAL ENT 25-TOPIC HARD-GATE FAILURES"); print("\n".join(failures)); raise SystemExit(1)
    print("PASS: 25 exact canonical General ENT / Emergencies topics retain complete reviewed ladders and quality contracts")
