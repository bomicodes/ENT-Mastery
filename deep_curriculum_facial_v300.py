"""v30.0 production wrapper — preserves facial/rhinology rebuilds and chains v30.5 head & neck semantics."""
...
from deep_curriculum_headneck_v305 import apply_headneck_neck_dissection_rebuild_v305
...
def apply_facial_noe_rebuild_v300(data_module, app_module=None):
    ...
    neck_dissection_result = apply_headneck_neck_dissection_rebuild_v305(data_module, app_module)
    return {
        ...
        "v305_neck_dissection": neck_dissection_result,
    }
