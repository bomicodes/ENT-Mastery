"""v25.4 — strict 25-topic Laryngology deliberate-learning-ladder progress gate.

Protects exact canonical progress across the first five reviewed Laryngology batches.
...
def main():
    ...
    if failures:
        ...
        print("\n".join(failures))
        raise SystemExit(1)
    print("PASS: 25 exact canonical Laryngology topics retain complete reviewed ladders and quality contracts")
