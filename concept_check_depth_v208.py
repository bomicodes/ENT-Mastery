...
COHORT={QID:{
 ...
 "depth_layers_v208":{"foundation":"Know anterior versus posterior nasal vascular anatomy, effective compression, clot evacuation, topical vasoconstriction and source-directed cautery.","application":"Choose packing when the source cannot be seen, use resorbable material for increased bleeding risk, and use endoscopy for recurrent unilateral or difficult-to-control bleeding.","senior_decision":"Recognize failure of packing/cautery, select SPA ligation versus embolization, manage anticoagulation proportionally to bleeding severity, and investigate recurrent disease such as HHT or neoplasm."},
 "common_traps_v208":["Declaring compression ineffective after a few seconds. Effective first-line compression is firm and sustained over the lower third of the nose for at least 5 minutes.","Cauterizing broadly without identifying a likely site. Excess mucosal injury can worsen crusting and septal injury while still missing a posterior source.","Using nonresorbable packing by default in a patient with an anticoagulant or bleeding disorder when current guidance favors resorbable packing for increased bleeding risk.","Treating packing as definitive follow-through. Patients need the packing type, removal plan when applicable, aftercare and clear return precautions documented.","Calling recurrent unilateral epistaxis 'posterior' and repeatedly packing without nasal endoscopy or evaluation for an unrecognized lesion.","Reversing anticoagulation immediately in a stable non-life-threatening bleed before applying appropriate local first-line treatments and considering the thrombotic indication for the drug.","Repeating posterior packs indefinitely after failed cautery/packing instead of evaluating for definitive surgical arterial ligation or endovascular embolization.","Assuming all recurrent epistaxis is local trauma and missing HHT clues such as recurrent bilateral bleeding, family history, and nasal/oral telangiectasias."],
