"""v20.8 — deepen exact live General ENT / Emergencies Peritonsillar Abscess Concept Check.
...
for _p in COHORT.values():
 ...
 _p["deliberate_review_v208"]="Selected from the exact successful v20.7 live-canonical backlog because Peritonsillar Abscess remained a 30-word management answer despite high ED, board, airway and bedside-procedure consequence. It was prioritized over higher lexical rank Epistaxis because the latter already has dedicated posterior-control/rescue depth elsewhere in the live curriculum."
