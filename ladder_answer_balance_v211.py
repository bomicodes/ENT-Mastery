...
Sleep Surgery; v26.9-v27.4 complete exact-canonical General ENT / Emergencies review.
"""
...
from pediatric_ear_semantic_alignment_v289 import apply_pediatric_ear_semantic_alignment_v289
...
from vignette_ladders_v274 import apply_learning_ladders_v274
from laryngology_foundation_alignment_v252 import apply_laryngology_foundation_alignment_v252
from hn_salvage_ladder_alignment_v288 import apply_hn_salvage_ladder_alignment_v288
from hn_neck_semantic_alignment_v294 import apply_hn_neck_semantic_alignment_v294
from facial_frontal_sinus_management_v295 import apply_facial_frontal_sinus_management_v295
from rhinology_rhinitis_semantic_alignment_v297 import apply_rhinology_rhinitis_semantic_alignment_v297
from facial_noe_management_alignment_v298 import apply_facial_noe_management_alignment_v298
from sleep_peds_psg_management_v299 import apply_sleep_peds_psg_management_v299
TARGET_PREFIXES=("v209_","v210_","v212_","v213_","v216_","v218_","v219_","v220_","v221_","v222_","v223_","v224_","v225_","v227_","v228_","v231_","v233_","v234_","v235_","v236_","v237_","v238_","v239_","v241_","v242_","v243_","v244_","v245_","v246_","v247_","v248_","v249_","v251_","v252_","v253_","v254_","v255_","v256_","v257_","v258_","v259_","v260_","v261_","v262_","v263_","v264_","v266_","v267_","v268_","v269_","v270_","v271_","v272_","v273_","v274_","v295_","v299_")
def _prefix(qid):
 text=str(qid or "")
...
def apply_ladder_answer_balance_v211(challenges):
 ...
 for fn in (apply_learning_ladders_v241,apply_learning_ladders_v242,apply_learning_ladders_v243,apply_learning_ladders_v244,apply_learning_ladders_v245,apply_learning_ladders_v246,apply_learning_ladders_v247,apply_learning_ladders_v248): fn(challenges,data._v6_item_id)
 apply_pediatric_ear_semantic_alignment_v289(challenges,data._v6_item_id)
 for fn in (apply_learning_ladders_v249,apply_learning_ladders_v251,apply_learning_ladders_v252): fn(challenges,data._v6_item_id)
 ...
 apply_learning_ladders_v274(challenges,data._v6_item_id)
 apply_hn_salvage_ladder_alignment_v288(challenges,data._v6_item_id)
 apply_hn_neck_semantic_alignment_v294(challenges,data._v6_item_id)
 apply_facial_frontal_sinus_management_v295(challenges,data._v6_item_id)
 apply_rhinology_rhinitis_semantic_alignment_v297(challenges,data._v6_item_id)
 apply_facial_noe_management_alignment_v298(challenges,data._v6_item_id)
 apply_sleep_peds_psg_management_v299(challenges,data._v6_item_id)
 groups=defaultdict(list)
 for q in challenges:
  if not q.get("ladder_reviewed"): continue
  prefix=_prefix(q.get("id"))
  if prefix and q.get("learning_stage") in {"foundation","application","management","senior_decision"}: groups[prefix].append(q)
 moved=0; summary={}
