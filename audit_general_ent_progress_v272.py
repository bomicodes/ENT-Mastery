"""v27.2 — strict General ENT / Emergencies 20-topic deliberate-ladder hard gate."""
...
def main():
    ...
    if failures:
        print("GENERAL ENT 20-TOPIC HARD-GATE FAILURES"); print("\n".join(failures)); raise SystemExit(1)
    print("PASS: 20 exact canonical General ENT / Emergencies topics retain complete reviewed ladders and quality contracts")
