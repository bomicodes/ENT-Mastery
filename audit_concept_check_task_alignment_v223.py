"""v20.23 exact-live ENT Fluids / Electrolytes / Nutrition task/source/semantic gate."""
...
def main():
    ...
    for qid in QIDS:
        ...
        refs=list(q.get("source_refs_v223") or []); reftext=" ".join(str(x.get("citation") or "") for x in refs if isinstance(x,dict)).lower()
    ...
    print("PASS: v20.23 ENT fluids/electrolytes/nutrition has exact-live linkage, resuscitation/maintenance separation, sodium/electrolyte rescue, refeeding safeguards, enteral-first nutrition and explicit stop/reassess reasoning")
