...
PATCHES_V165 = {
    ...
    "Laryngology / Voice / Swallowing": [
        _entry(
            ...
            "An immobile vocal fold on one side causes breathy dysphonia, weak cough, vocal fatigue and variable dysphagia/aspiration, but that immobility is a finding rather than an etiologic diagnosis. Causes include iatrogenic vagal/RLN injury, malignancy anywhere along the nerve course, skull-base/central neurologic disease, intubation/arytenoid injury and idiopathic neuropathy. Position alone does not reliably identify lesion level.",
