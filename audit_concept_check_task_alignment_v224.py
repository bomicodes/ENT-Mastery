"""v20.24 exact-live Neurotologic Intraoperative Cranial-Nerve Monitoring task/source/semantic gate."""
import runtime_entry
from concept_check_board_repair_v177 import _find_module
from concept_check_depth_v224 import COHORT, QIDS

SEMANTIC_GROUPS = {
    "adjunct": ("adjunct", "anatomy"),
    "facial_modalities": ("free-running emg", "triggered stimulation"),
    "auditory_modalities": ("abr/baep", "near-field", "cnap"),
    "anesthesia": ("neuromuscular blockade", "train-of-four", "threshold"),
    "auditory_interpretation": ("latency", "amplitude", "averaging", "universal"),
    "warning": ("stop", "traction", "drilling"),
    "technical": ("electrodes", "impedance", "probe", "transducer"),
    "localize": ("proximal", "distal", "localize"),
    "rescue": ("release", "thermal", "change the surgical"),
    "functional_tradeoff": ("hearing", "facial", "subtotal"),
}
SOURCE_ANCHORS = (
