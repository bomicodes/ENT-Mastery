"""v20.9 hard gate for exact-canonical Peritonsillar Abscess depth and provenance."""
import re
...
def main():
 ...
 print('PASS: v20.9 Peritonsillar Abscess check has exact canonical depth, individualized traps and traceable current sources')
