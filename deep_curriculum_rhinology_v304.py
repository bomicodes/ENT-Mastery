...
COMPLICATED_SINUSITIS_V304 = {
    ...
    "intracranial complications of sinusitis": {
        ...
        "teach": "Chief/boards framework: NEUROLOGIC RED FLAG + SINUSITIS = IMAGE THE BRAIN, not another routine antibiotic course. MRI is the high-yield study for intracranial soft-tissue/venous complications; CT remains valuable for speed and bony/sinus operative anatomy. Subdural empyema is particularly dangerous and usually needs urgent neurosurgical source control. Pott puffy tumor means frontal osteomyelitis with subperiosteal abscess and mandates a search for intracranial extension. Focus here on meningeal, venous-sinus, extra-axial and brain infection; orbital vision-threatening findings are covered separately under orbital complications of sinusitis.",
