"""v20.20 exact-live task/source/semantic gate for Cranial Nerve Examination / Skull Base Localization."""
...
SEMANTIC_GROUPS = {
    ...
    "bell_boundary": ("bell palsy", "cranial neuropath", "atypical"),
...
def main():
    ...
    for qid in QIDS:
        ...
        refs = list(q.get("source_refs_v220") or [])
        ...
        for anchor in ("cummings", "pasha", "k.j. lee", "acr", "fda", "durable"):
    ...
    print("PASS: v20.20 cranial-nerve/skull-base cohort has exact canonical linkage, core-text/current-source traceability, foundation/application/senior depth, individualized traps and functional/vascular bailout reasoning")
