"""v25.3 — strict 20-topic Laryngology deliberate-learning-ladder progress gate.

Protects exact canonical progress across the first four reviewed Laryngology batches.
...
def main():
    ...
    if failures:
        ...
        print("\n".join(failures))
        raise SystemExit(1)
    print("PASS: 20 exact canonical Laryngology topics retain complete reviewed ladders and quality contracts")
