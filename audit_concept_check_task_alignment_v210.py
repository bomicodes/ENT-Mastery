"""v20.10 hard gate for exact-canonical Peritonsillar Abscess depth and provenance."""
import re
...
SEMANTIC_REQUIREMENTS={
 "presentation":(("trismus",),("hot potato","muffled"),("uvular",)),
 "triage":(("airway",),("hydration","oral intake","secretions")),
 "diagnostic_reset":(("cellulitis","phlegmon"),("ultrasound",),("ct",)),
 "drainage":(("needle aspiration",),("incision",),("blunt",)),
 "carotid_safety":(("carotid",),("lateral",),("controlled depth","staying medial","stay medial")),
 "failed_drainage":(("negative aspiration","failed bedside drainage","failed drainage"),("relocal","reconsider","reset")),
 "deep_neck":(("parapharyngeal","retropharyngeal"),("lemierre",)),
 "tonsillectomy":(("quinsy",),("interval tonsillectomy",),("individual",)),
}
...
def main():
 ...
 for qid in QIDS:
  ...
  for required in ('cummings','pasha','k.j. lee','kim','todsen','li ac','voruz'):
 ...
 if set(align.get('repaired') or [])!=set(QIDS): failures.append('runtime_repaired_set_mismatch')
 print('V210_TARGETS|'+','.join(QIDS)); print(f'V210_FAILURES|{len(failures)}')
 for f in failures: print('FAIL|'+f)
 if failures: raise SystemExit(1)
 print('PASS: v20.10 Peritonsillar Abscess check has exact canonical depth, individualized traps and traceable current sources')
