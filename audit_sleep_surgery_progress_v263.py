"""v26.3 — strict Sleep Surgery deliberate-ladder progress gate."""
...
def main():
    ...
    print("PASS: first 5 exact canonical Sleep Surgery topics retain complete reviewed ladders and quality contracts")
