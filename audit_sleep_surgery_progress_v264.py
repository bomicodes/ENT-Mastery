"""v26.4 — strict Sleep Surgery deliberate-ladder progress gate."""
...
def main():
    ...
    print("PASS: first 10 exact canonical Sleep Surgery topics retain complete reviewed ladders and quality contracts")
