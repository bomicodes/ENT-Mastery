"""v25.1 — strict 10-topic Laryngology deliberate-learning-ladder progress gate.

Protects exact canonical progress across the first two reviewed Laryngology batches.
...
def main():
    ...
    if failures:
        ...
        print("\n".join(failures))
        raise SystemExit(1)
    print("PASS: 10 exact canonical Laryngology topics retain complete reviewed ladders and quality contracts")
