...
SOURCE_REFS = [
    {"type": "textbook", "citation": "Cummings Otolaryngology–Head and Neck Surgery, 7th ed. (2021), connected Google Drive full-volume copy ID 18QGOAaZhvH-kEUJxtwDWXn1ho86PRY-t. Cross-referenced for facial-pain differential diagnosis, rhinogenic disease, migraine mimics, and durable operative decision principles."},
    {"type": "textbook", "citation": "Pasha R, Golub JS. Otolaryngology–Head and Neck Surgery: Clinical Reference Guide, 6th ed. (2022), connected Google Drive ID 14E4Iy4XCjGPSyMT5n7uyURGtIDnhi-52. Cross-referenced for practical sinus-versus-headache differentiation and sinonasal workup."},
    {"type": "textbook", "citation": "K.J. Lee's Essential Otolaryngology, 12th ed. (2019), connected Google Drive ID 112c9y0fb1z_7OLP4aLlAG2z-r8weuXvR. Cross-referenced for facial pain, neuralgia, dental/TMJ mimics, and sinonasal surgical boundaries."},
    {"type": "classification", "citation": "International Headache Society. International Classification of Headache Disorders, 3rd edition (ICHD-3), section 11.5.2 Headache attributed to chronic or recurring rhinosinusitis. Requires objective sinonasal inflammatory evidence plus evidence of causation; imaging/endoscopic abnormalities alone do not secure the diagnosis."},
    {"type": "guideline", "citation": "AAO-HNSF Clinical Practice Guideline: Adult Sinusitis Update (2025). Used for current objective-confirmation and alternative-diagnosis principles in chronic rhinosinusitis rather than treating facial pressure alone as proof of sinus disease."},
]
...
CHECK = {
    ...
    "learner_experience_v233": {"deep_curriculum": True, "concept_check": True, "daily_curriculum": True, "sources_visible": True},
}
