"""v25.8 — strict 10-topic Facial Plastics / Trauma deliberate-ladder progress gate."""
...
def main():
    ...
    if failures:
        ...
        print("\n".join(failures))
        raise SystemExit(1)
    print("PASS: 10 exact canonical Facial Plastics / Trauma topics retain complete reviewed ladders and quality contracts")
