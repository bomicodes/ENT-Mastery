"""v20.8 hard gate for exact-canonical Peritonsillar Abscess depth and provenance."""
import re
...
def main():
 ...
 align=final_gate.get('task_alignment_v208') or {}
 ...
 print('PASS: v20.8 Peritonsillar Abscess check has exact canonical depth, individualized traps and traceable current sources')
