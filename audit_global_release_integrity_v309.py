...
esophageal-perforation, post-laryngectomy pharyngocutaneous-fistula, and shared-airway
fire rescue gates. The manifest also verifies that edits to source-saturation and OR
rescue audit families themselves trigger this global release workflow and that the
newest validated Concept Check alignment/backlog cohort cannot be silently omitted
