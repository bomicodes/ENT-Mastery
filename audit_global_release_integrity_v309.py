...
esophageal-perforation, and post-neck-dissection chyle-leak rescue gates. The manifest
also verifies that edits to source-saturation audit families themselves trigger this
global release workflow and that the newest validated Concept Check alignment/backlog
cohort cannot be silently omitted from release validation.
"""
...
from audit_or_neck_chyle_leak_rescue_v286 import main as _v286_chyle_main
...
CHYLE_GATE = "audit_or_neck_chyle_leak_rescue_v286.py"
...
def main():
    ...
    print("GLOBAL_RELEASE_NECK_CHYLE_LEAK_RESCUE_GATE|" + CHYLE_GATE)
    chyle_rc = _v286_chyle_main()
    if chyle_rc:
        raise SystemExit(chyle_rc)
    print("PASS: global release protects post-neck-dissection cervical chyle-leak rescue and source-control decisions")
