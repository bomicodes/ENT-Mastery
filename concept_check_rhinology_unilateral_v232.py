...
SOURCE_REFS = [
    {"type": "textbook", "citation": "Cummings Otolaryngology–Head and Neck Surgery, 7th ed. (2021), connected Google Drive full-volume copy ID 18QGOAaZhvH-kEUJxtwDWXn1ho86PRY-t. Cross-referenced for unilateral sinonasal evaluation, neoplasm/skull-base differential, imaging selection, and biopsy safety principles."},
    {"type": "textbook", "citation": "Pasha R, Golub JS. Otolaryngology–Head and Neck Surgery: Clinical Reference Guide, 6th ed. (2022), connected Google Drive ID 14E4Iy4XCjGPSyMT5n7uyURGtIDnhi-52. Cross-referenced for practical unilateral obstruction/mass differential, endoscopy, CT/MRI workup, odontogenic disease, and tumor red flags."},
    {"type": "textbook", "citation": "K.J. Lee's Essential Otolaryngology, 12th ed. (2019), connected Google Drive ID 112c9y0fb1z_7OLP4aLlAG2z-r8weuXvR. Cross-referenced for durable sinonasal tumor, fungal, dental, vascular, and skull-base diagnostic principles."},
]
...
CHECK = {
    ...
    "search_aliases": ["unilateral sinonasal disease", "unilateral sinus disease", "unilateral nasal mass", "unilateral nasal obstruction", "unilateral sinus opacification"],
    "source_refs_v230": SOURCE_REFS,
    "learner_experience_v232": {"deep_curriculum": True, "concept_check": True, "daily_curriculum": True, "sources_visible": True},
}
