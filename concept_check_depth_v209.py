"""v20.9 — deepen exact live General ENT / Emergencies Peritonsillar Abscess Concept Check.
...
for _p in COHORT.values():
 _p["common_traps_v209"]=list(TRAPS)
 _p["deliberate_review_v209"]="Selected from the exact successful live-canonical backlog because Peritonsillar Abscess remained shallow despite high ED, board, airway and bedside-procedure consequence. It was rehomed after concurrent v20.8 Epistaxis work reached validated main, preserving the newer lineage rather than overwriting it."
 _p["source_refs_v209"]=SOURCE_REFS_V209
...
def apply_concept_check_task_alignment_v209(checks, deep_modules, v6_item_id):
 ...
 for qid,p in COHORT.items():
  ...
  q['task_alignment_v209']=True; repaired.append(qid)
