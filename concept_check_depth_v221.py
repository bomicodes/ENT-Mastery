...
Three-dimensional facial frame — restore the vertical and horizontal buttresses that transmit load and define facial form. The reconstruction must re-establish zygomatic width, vertical facial height and anterior projection. The zygoma must be positioned in three dimensions, not simply aligned at one easy-to-see rim. A small error at an early reference propagates across the face; plates hold a reduction, but they cannot rescue a wrong skeletal framework.
