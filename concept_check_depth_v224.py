...
Contemporary society guidance and 2025-2026 evidence are explicitly separated from
manufacturer- and procedure-specific numeric thresholds.
"""
...
SOURCE_REFS_V224 = [
    ...
    {"type":"systematic_review","citation":"Barrameda BN, Gogulapati A, Guo K, Squires L. Efficacy of Intraoperative Facial Nerve Monitoring in Parotidectomy: A Systematic Review and Meta-Analysis (1970-2025). Otolaryngol Head Neck Surg. 2026;174(2):291-296. PMID: 41353726.","role":"current outcome evidence: monitoring was associated with reduced immediate and permanent weakness in pooled primary-parotidectomy studies, while observational/confounding limitations remain"},
...
CURRENT EVIDENCE — AAO-HNS states that otolaryngologists are trained to perform and strategically use intraoperative cranial nerve monitoring as an adjunct to anatomic knowledge and surgical technique. Recent parotid meta-analyses associate monitoring with lower postoperative weakness in pooled data, but effect estimates differ across analyses and prospective evidence is less definitive than pooled observational results. Monitoring therefore complements meticulous surgery; it does not guarantee facial function and does not excuse unsafe dissection.
...
COHORT = {QIDS[0]: {
    ...
    "evidence_distinction_v224": "Durable textbook principles are anatomy-led facial-nerve identification, monitoring as an adjunct, EMG physiology, control of neuromuscular-blockade/technical confounders, and immediate stop/troubleshoot/rescue when a signal deteriorates. Current AAO-HNS guidance supports strategic cranial-nerve monitoring as an adjunct to anatomy and technique. Contemporary 2025-2026 parotid evidence supports clinical utility but remains heterogeneous for predictive numeric parameters; no universal amplitude-loss percentage, stimulation threshold or latency cutoff should be taught across procedures/devices. FDA device regulation and manufacturer settings do not create a universal clinical alarm threshold.",
    "choices": [],
    "answer": None,
}}
