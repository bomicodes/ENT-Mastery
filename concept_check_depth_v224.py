...
COHORT = {QIDS[0]: {
    ...
    "evidence_distinction_v224": "Durable textbook principles are anatomy-led facial-nerve identification, monitoring as an adjunct, EMG physiology, control of neuromuscular-blockade/technical confounders, and immediate stop/troubleshoot/rescue when a signal deteriorates. Current AAO-HNS guidance and consensus support strategic cranial-nerve monitoring as an adjunct to anatomy and technique, with procedure-specific evidence strength. The non-retracted 2025 parotid systematic review remains heterogeneous for predictive numeric parameters; no universal amplitude-loss percentage, stimulation threshold or latency cutoff should be taught across procedures/devices. The 2026 Barrameda meta-analysis (PMID 41353726) was retracted July 28, 2026 (PMID 42520282), so its pooled benefit estimates are excluded. FDA device regulation and manufacturer settings do not create a universal clinical alarm threshold.",
    "choices": [],
    "answer": None,
}}
