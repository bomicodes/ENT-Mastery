...
DEPTH_V401 = {
    ...
    "Otology / Neurotology": {
        ...
        "Vestibular Neuritis": {
            "recognize": (
                """Suspect an acute unilateral peripheral vestibulopathy when a sustained acute vestibular syndrome presents with continuous vertigo/dizziness, spontaneous peripheral-pattern nystagmus, nausea and gait unsteadiness, without acute cochlear symptoms or focal central neurologic signs. These absences do NOT by themselves rule out posterior-circulation stroke. New hearing loss raises concern for labyrinthine disease AND for an AICA-territory stroke in the appropriate clinical setting; assess hearing rather than assuming it guarantees a benign diagnosis."""
            ),
            "localize": (
